#!/bin/bash
#SBATCH --job-name=InfiniViT_Policy_MyWayHome             # Job name
...
#SBATCH --output=run_policy_infini_rnd_my_way_home.log           # Standard output and error log
