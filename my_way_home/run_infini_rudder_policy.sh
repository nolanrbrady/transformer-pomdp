#!/bin/bash
#SBATCH --job-name=Infini_Rudder_Policy_MyWayHome             # Job name
...
#SBATCH --output=run_policy_infini_rudder_my_way_home.log           # Standard output and error log
