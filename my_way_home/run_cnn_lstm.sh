#!/bin/bash
#SBATCH --job-name=CNN_LSTM_Policy_MyWayHome             # Job name
...
#SBATCH --output=run_policy_cnn_lstm_my_way_home.log           # Standard output and error log
