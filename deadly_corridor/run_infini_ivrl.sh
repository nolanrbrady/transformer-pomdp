#!/bin/bash
#SBATCH --job-name=infini_ivrl_my_way_home             # Job name
...
#SBATCH --output=run_policy_infini_ivrl_my_way_home.log           # Standard output and error log
